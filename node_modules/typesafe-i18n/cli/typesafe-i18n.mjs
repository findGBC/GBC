...
// ../config/src/config.mts
var writeConfigToFile = async (config) => writeConfigFile({ ...config, $schema: `https://unpkg.com/typesafe-i18n@${version}/schema/typesafe-i18n.json` });
...
// ../../node_modules/.pnpm/just-diff@5.2.0/node_modules/just-diff/index.mjs
...
// src/setup/detect-setup.mts
var useAdapterWhenDependenciesContain = (shouldContain) => (dependencies) => shouldContain.reduce((prev, dep) => prev || dependencies.includes(dep), false);
...
var showSponsoringMessage = () => console.log(`
