...
var initI18nSolid = (translations, formatters = {}) => {
  const I18nContext = (0, import_solid_js.createContext)({});
  const TypesafeI18n = (props) => {
    const [locale, _setLocale] = (0, import_solid_js.createSignal)(null);
    const [LL, setLL] = (0, import_solid_js.createSignal)(getFallbackProxy());
    const setLocale = (newLocale) => (0, import_solid_js.batch)(() => {
      _setLocale(() => newLocale);
      setLL(() => i18nObject(newLocale, translations[newLocale], formatters[newLocale]));
    });
    setLocale(props.locale);
    return (0, import_solid_js.createComponent)(I18nContext.Provider, {
  ...
  const useI18nContext = () => (0, import_solid_js.useContext)(I18nContext);
