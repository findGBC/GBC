...
__export(src_exports, {
  I18nServiceRoot: () => I18nServiceRoot
});
...
// src/index.mts
var wrapProxy = (proxyObject) => new Proxy(proxyObject, {
  get: (target, key) => !(target === proxyObject && key === "then") && proxyObject[key]
});
var _locale, _LL;
var I18nServiceRoot = class {
  constructor(translations, formatters) {
    this.translations = translations;
    this.formatters = formatters;
    __privateAdd(this, _locale, null);
    __privateAdd(this, _LL, wrapProxy(getFallbackProxy()));
  }
  get locale() {
    return __privateGet(this, _locale);
  }
  get LL() {
    return __privateGet(this, _LL);
  }
  setLocale(newLocale) {
    __privateSet(this, _locale, newLocale);
    __privateSet(this, _LL, wrapProxy(i18nObject(newLocale, this.translations[newLocale], this.formatters[newLocale])));
  }
};
_locale = new WeakMap();
_LL = new WeakMap();
