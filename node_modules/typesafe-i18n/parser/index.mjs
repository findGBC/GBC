...
var enhanceTypeInformation = (parts) => {
  ...
  parameterParts.forEach(({ key, types, transforms, optional }) => {
    ...
    typeMap[key] = {
      types: uniqueArray([...((_a = typeMap[key]) == null ? void 0 : _a.types) || [], ...enhancedTypes]).filter(isNotUndefined),
      optional: ((_b = typeMap[key]) == null ? void 0 : _b.optional) || optional
    };
  });
  pluralParts.forEach(({ key }) => {
    var _a;
    if (!((_a = typeMap[key]) == null ? void 0 : _a.types.length)) {
  ...
  Object.keys(typeMap).forEach((key) => {
    var _a, _b;
    if (!((_a = typeMap[key]) == null ? void 0 : _a.types.length)) {
      typeMap[key] = { types: ["unknown"], optional: ((_b = typeMap[key]) == null ? void 0 : _b.optional) || false };
    }
  });
...
var parseTypesFromSwitchCaseStatement = (formatters) => {
  if (!(formatters == null ? void 0 : formatters.length))
    return [];
