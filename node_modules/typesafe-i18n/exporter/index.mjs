...
var require_sync = __commonJS({
  "../../node_modules/.pnpm/tiny-glob@0.2.9/node_modules/tiny-glob/sync.js"(exports, module) {
    ...
    var { join: join2, resolve: resolve5, relative } = __require("path");
    var isHidden = /(^|[\\\/])\.[^\\\/\.]/g;
    var CACHE = {};
...
`);
  ...
  const outputPathParts = resolve3(outputPath, locale).replace(resolve3(), "").split(sep).filter(import_typesafe_utils2.isTruthy);
...
var readTranslation = async (locale, outputPath, outputFormat2, tempPath, typesFileName) => {
  ...
  for (const namespace of namespaces) {
    ...
    translations[namespace] = await parseLanguageFile(
      ...
      outputFormat2,
      typesFileName,
      resolve4(tempPath, locale, namespace),
      locale,
      namespace
    ) || {};
  }
