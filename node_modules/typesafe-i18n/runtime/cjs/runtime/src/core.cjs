...
const applyFormatters = (formatters, formatterKeys, initialValue) => formatterKeys.reduce((value, formatterKey) => {
    var _a, _b;
    return (_b = (formatterKey.match(basic_mjs_1.REGEX_SWITCH_CASE)
        ? ((cases) => { var _a; return (_a = cases[value]) !== null && _a !== void 0 ? _a : cases['*']; })((0, basic_mjs_1.parseCases)(formatterKey))
...
const applyArguments = (textParts, pluralRules, formatters, args) => textParts
    ...
    if ((0, basic_mjs_1.isBasicPluralPart)(part)) {
